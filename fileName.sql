;             
CREATE USER IF NOT EXISTS "SA" SALT 'd54fc471241b6ce1' HASH '2ee1b1c33ce1bd5b02597000a0784a531ab3e03d1a772fb35dd2a004aa82ece1' ADMIN;         
CREATE MEMORY TABLE "PUBLIC"."VEICULO"(
    "ID" BINARY NOT NULL,
    "ANO" INTEGER,
    "CREATED" TIMESTAMP,
...
ALTER TABLE "PUBLIC"."VEICULO" ADD CONSTRAINT "PUBLIC"."CONSTRAINT_3" PRIMARY KEY("ID");      
-- 9 +/- SELECT COUNT(*) FROM PUBLIC.VEICULO; 
